...
<!-- badges: start -->
  [![Travis build status](https://travis-ci.org/curso-r/bltm.svg?branch=master)](https://travis-ci.org/curso-r/bltm)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/curso-r/bltm?branch=master&svg=true)](https://ci.appveyor.com/project/curso-r/bltm)
[![CRAN status](https://www.r-pkg.org/badges/version/bltm)](https://cran.r-project.org/package=bltm)
<!-- badges: end -->
...
```{r betas, fig.height=5, fig.width=7, eval=TRUE}
